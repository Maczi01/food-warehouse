...
var A$1 = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            if (t.R !== e) throw new b(A$1.ABORTED, "getToken aborted due to token change.");
            return n ? (Le("string" == typeof n.accessToken), new N$1(n.accessToken, t.currentUser)) : null;
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new b(A$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new b(A$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new b(A$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new b(A$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
...
var R$1 = /** @class */ function() {
    ...
    n.K = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new b(A$1.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
var L$1 = /^[_a-zA-Z][_a-zA-Z0-9]*$/, O$1 = /** @class */ function(e) {
    ...
    n.Z = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new b(A$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new b(A$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new b(A$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new b(A$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n;
}(R$1);
...
var P$1 = /** @class */ function() {
    function t(t, e) {
        this.$ = t, this.root = e || M$1.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.nt = function(e, n) {
        return new t(this.$, this.root.nt(e, n, this.$).rt(null, null, M$1.ht, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.$, this.root.remove(e, this.$).rt(null, null, M$1.ht, null, null));
    }, 
    ...
    t.prototype.lt = function() {
        return new C$1(this.root, null, this.$, !1);
    }, t.prototype._t = function(t) {
        return new C$1(this.root, t, this.$, !1);
    }, t.prototype.ft = function() {
        return new C$1(this.root, null, this.$, !0);
    }, t.prototype.dt = function(t) {
        return new C$1(this.root, t, this.$, !0);
    }, t;
}(), C$1 = /** @class */ function() {
    function t(t, e, n, r) {
        this.wt = r, this.Tt = [];
...
var q$1 = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.Nt = function(t) {
        ...
        return new G$1(this.data.lt());
    }, t.prototype._t = function(t) {
        return new G$1(this.data._t(t));
    }, 
...
/** Extracts the backend's type order for the provided value. */ function X$1(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? Y$1(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : Ve();
}
...
function Z$1(t, e) {
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return J$1(t.timestampValue, e.timestampValue);

      case 4 /* ServerTimestampValue */ :
        return J$1(H$1(t), H$1(e));
...
var wt = /** @class */ function() {
     ...
     */
    t.Jt = function(t) {
        return t instanceof St ? t.version : D$1.MIN;
    }, t;
}(), Et = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return __extends(n, e), n.prototype.xt = function(t, e) {
        this.Xt(t);
    ...
    return __extends(n, e), n.prototype.xt = function(t, e) {
        ...
        return this.Xt(t), this.Zt.Yt(t) ? new Dt(this.key, D$1.S()) : t;
    }, n.prototype.ee = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
    ...
    t.prototype.se = function() {
        ...
        var e = this, n = new q$1(O$1.$);
        return x$1(t.fields || {}, (function(t, r) {
            var i = new O$1([ t ]);
            if (10 /* ObjectValue */ === X$1(r)) {
...
var _t = /** @class */ function() {
    ...
    return __extends(n, e), n.prototype.field = function(t) {
        ...
        return null !== r && null !== i ? Z$1(r, i) : Ve();
    }, n;
    ...
    t.prototype.qe = function() {
        ...
        var e = t.key.path;
        return null !== this.collectionGroup ? t.key.et(this.collectionGroup) && this.path.U(e) : U$1.st(this.path) ? this.path.isEqual(e) : this.path.W(e);
    }, 
    /**
...
var Ut = /** @class */ function(e) {
     ...
     */    return __extends(n, e), n.create = function(t, e, r) {
        ...
        if (ut(r)) {
            if (e !== Ot.EQUAL) throw new b(A$1.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (at(r)) {
            if (e !== Ot.EQUAL) throw new b(A$1.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        ...
        // Only compare types with matching backend order (such as double and int).
                return null !== e && X$1(this.value) === X$1(e) && this.Xe(Z$1(e, this.value));
...
var xt, Bt, jt = /** @class */ function() {
    ...
    t.prototype.Ye = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.X() ? U$1.$(U$1.tt(o.referenceValue), e.key) : Z$1(o, e.field(i.field)), 
...
}(), Qt = new zt(O$1.J(), Ft.ASCENDING), Yt = new zt(O$1.J(), Ft.DESCENDING), Ht = /** @class */ function() {
    function t(
     ...
     */ , s) {
        void 0 === i && (i = D$1.MIN), void 0 === o && (o = D$1.MIN), void 0 === s && (s = j.qt), 
...
function Xt(t) {
    switch (t) {
      ...
      case A$1.CANCELLED:
      case A$1.UNKNOWN:
      case A$1.DEADLINE_EXCEEDED:
      case A$1.RESOURCE_EXHAUSTED:
      case A$1.INTERNAL:
      case A$1.UNAVAILABLE:
 // Unauthenticated means something went wrong with our token and we need
        // to retry with new credentials which will happen automatically.
              case A$1.UNAUTHENTICATED:
        return !1;

      case A$1.INVALID_ARGUMENT:
      case A$1.NOT_FOUND:
      case A$1.ALREADY_EXISTS:
      case A$1.PERMISSION_DENIED:
      case A$1.FAILED_PRECONDITION:
 // Aborted might be retried in some scenarios, but that is dependant on
        // the context and should handled individually by the calling code.
        // See https://cloud.google.com/apis/design/errors.
              case A$1.ABORTED:
      case A$1.OUT_OF_RANGE:
      case A$1.UNIMPLEMENTED:
      case A$1.DATA_LOSS:
        return !0;
 ...
 */ function $t(t) {
    ...
    return De("GRPC error has no .code"), A$1.UNKNOWN;
    switch (t) {
      case xt.OK:
        return A$1.OK;

      case xt.CANCELLED:
        return A$1.CANCELLED;

      case xt.UNKNOWN:
        return A$1.UNKNOWN;

      case xt.DEADLINE_EXCEEDED:
        return A$1.DEADLINE_EXCEEDED;

      case xt.RESOURCE_EXHAUSTED:
        return A$1.RESOURCE_EXHAUSTED;

      case xt.INTERNAL:
        return A$1.INTERNAL;

      case xt.UNAVAILABLE:
        return A$1.UNAVAILABLE;

      case xt.UNAUTHENTICATED:
        return A$1.UNAUTHENTICATED;

      case xt.INVALID_ARGUMENT:
        return A$1.INVALID_ARGUMENT;

      case xt.NOT_FOUND:
        return A$1.NOT_FOUND;

      case xt.ALREADY_EXISTS:
        return A$1.ALREADY_EXISTS;

      case xt.PERMISSION_DENIED:
        return A$1.PERMISSION_DENIED;

      case xt.FAILED_PRECONDITION:
        return A$1.FAILED_PRECONDITION;

      case xt.ABORTED:
        return A$1.ABORTED;

      case xt.OUT_OF_RANGE:
        return A$1.OUT_OF_RANGE;

      case xt.UNIMPLEMENTED:
        return A$1.UNIMPLEMENTED;

      case xt.DATA_LOSS:
        return A$1.DATA_LOSS;
 ...
 */ var ae = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.$ = t ? function(e, n) {
            return t(e, n) || U$1.$(e.key, n.key);
        } : function(t, e) {
            return U$1.$(t.key, e.key);
        }, this.rs = ee(), this.hs = new P$1(this.$)
        /**
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, le.Rs(e, n)), new t(D$1.MIN, r, ue(), Zt(), oe());
    }, t;
}(), le = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.ri = function(t) {
        ...
        return this.js = Zt(), this.Gs = ge(), this.Ks = new q$1(Ue), i;
    }, 
    /**
    ...
    t.prototype.Bs = function(t) {
        ...
        var e = this.Gs.get(t);
        return e || (e = new q$1(Ue), this.Gs = this.Gs.nt(t, e)), e;
    }, 
    /**
 ...
 */ var Ee = function() {
    ...
    return t.prototype.li = function(t) {
        var e = void 0 === t.code ? A$1.UNKNOWN : $t(t.code);
    ...
    t.prototype._i = function(t) {
        return this.options.fi || z$1(t) ? t : {
            value: t
        };
    }, 
    /**
    ...
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.yi = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            d.document;
            var y = this.tt(d.document), v = d.readTime ? this.fromVersion(d.readTime) : D$1.S(), m = new Dt(y, v), g = d.removedTargetIds || [];
            e = new pe([], g, m.key, m);
        ...
        if (!("targetChange" in t)) return D$1.MIN;
        var e = t.targetChange;
        return e.targetIds && e.targetIds.length ? D$1.MIN : e.readTime ? this.fromVersion(e.readTime) : D$1.MIN;
...
function(t, e, n, r, i) {
    ...
    function t() {
        ...
        this.gn = new q$1(Be.Ee), 
        // A set of outstanding references to a document sorted by target id.
        this.yn = new q$1(Be.bn)
     ...
     */
    t.prototype.Nn = function(t) {
        var e = this, n = U$1.EMPTY, r = new Be(n, t), i = new Be(n, t + 1), o = [];
        ...
        var e = U$1.EMPTY, n = new Be(e, t), r = new Be(e, t + 1), i = oe();
    ...
    return t.Ee = function(t, e) {
        return U$1.$(t.key, e.key) || Ue(t.On, e.On);
    }, 
    /** Compare by ID then by key */ t.bn = function(t, e) {
        return Ue(t.On, e.On) || U$1.$(t.key, e.key);
    }, t;
}(), je = /** @class */ function() {
    function t(t) {
        var e = this;
    ...
    t.prototype.rr = function(t, e, n) {
        ...
        return this.Xn(t, new U$1(e)).next((function(t) {
            var e = ee();
...
var He = function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.Mr && (this.clearTimeout(), this.Lr.reject(new b(A$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
...
var Ze = /** @class */ function() {
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.q(), n = t.O(), r = this.index[e] || new q$1(V$1.$), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.q(), n = t.O(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new q$1(V$1.$)).j();
    }, t;
}(), en = /** @class */ function() {
    function t(
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.Dh = D$1.MIN, this.persistence.Fh.Ch(this.bh), this.zn = t.Nh(n), this.$h = t.kh(), 
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.Es.forEach((function(i, h) {
                    ...
                    // cache.
                                        h instanceof Dt && h.version.isEqual(D$1.MIN) ? (
    ...
    t.prototype.vo = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.Vo(o, t.qe()).next((function(t) {
                ...
                return n.yh.rr(o, t, e ? r : D$1.MIN, e ? i : oe());
            })).next((function(t) {
                return {
                    documents: t,
                    Do: i
...
function nn(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            if (t.code !== A$1.FAILED_PRECONDITION || "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab." !== t.message) throw t;
 ...
 */ function rn(t, e) {
    if (0 !== e.length) throw new b(A$1.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + An(e.length, "argument") + ".");
}
 ...
 */ function on(t, e, n) {
    if (e.length !== n) throw new b(A$1.INVALID_ARGUMENT, "Function " + t + "() requires " + An(n, "argument") + ", but was called with " + An(e.length, "argument") + ".");
}
 ...
 */ function sn(t, e, n) {
    if (e.length < n) throw new b(A$1.INVALID_ARGUMENT, "Function " + t + "() requires at least " + An(n, "argument") + ", but was called with " + An(e.length, "argument") + ".");
}
 ...
 */ function un(t, e, n, r) {
    if (e.length < n || e.length > r) throw new b(A$1.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + An(e.length, "argument") + ".");
}
...
function ln(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var h = yn(r);
        throw new b(A$1.INVALID_ARGUMENT, "Invalid value " + h + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
...
/** Helper to validate the type of a provided input. */ function pn(t, e, n, r) {
    if (!("object" === e ? dn(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = yn(r);
        throw new b(A$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
function vn(t, e, n) {
    if (void 0 === n) throw new b(A$1.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + En(e) + " argument, but it was undefined.");
}
 ...
 */ function mn(t, e, n) {
    x$1(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new b(A$1.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function gn(t, e, n, r) {
    var i = yn(r);
    return new b(A$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + En(n) + " argument to be a " + e + ", but it was: " + i);
}

function wn(t, e, n) {
    if (n <= 0) throw new b(A$1.INVALID_ARGUMENT, 'Function "' + t + '()" requires its ' + En(e) + " argument to be a positive number, but it was: " + n + ".");
}
 ...
 */ function bn(t, e) {
    function n() {
        ...
        throw e && (t += " ", t += e), new b(A$1.INVALID_ARGUMENT, t);
    }
...
function Nn() {
    if ("undefined" == typeof Uint8Array) throw new b(A$1.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function In() {
    if (!Ie.Ot().$o) throw new b(A$1.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
...
var Tn = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        try {
            ...
            throw new b(A$1.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        !function(t, e, n, r) {
            if (!(e instanceof Array) || e.length < 1) throw new b(A$1.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + An(1, "element") + ".");
        }(0, t);
        for (var n = 0; n < t.length; ++n) if (an("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new b(A$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.Lo = new O$1(t);
    }
...
var Ln = /** @class */ function(e) {
    ...
    function t(t, e) {
        ...
        !isFinite(t) || t < -90 || t > 90) throw new b(A$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new b(A$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.xo = t, this.Uo = e;
    }
...
/** A "context" object passed around while parsing user data. */ var xn = /** @class */ function() {
    ...
    return t.prototype.Ko = function(e) {
        ...
        return new b(A$1.INVALID_ARGUMENT, "Function " + this.methodName + "() called with invalid data. " + t + e);
    }, 
    ...
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.ea = function(t, e, n) {
        var r = new xn(2 /* MergeSet */ , t, O$1.H);
        Qn("Data must be an object, but it was:", r, e);
        var i, o, s = this.ta(e, r);
        if (n) {
            for (var u = new q$1(O$1.$), a = 0, h = n; a < h.length; a++) {
                var c = h[a], f = void 0;
                if (c instanceof kn) f = c.Lo; else {
                    if ("string" != typeof c) throw Ve();
                    f = Hn(t, c);
                }
                if (!r.contains(f)) throw new b(A$1.INVALID_ARGUMENT, "Field '" + f + "' is specified in your field mask but missing from your input data.");
                u = u.add(f);
            }
    ...
    /** Parse update data from an update() call. */ t.prototype.sa = function(t, e) {
        var n = this, r = new xn(1 /* Update */ , t, O$1.H);
        Qn("Data must be an object, but it was:", r, e);
        var i = new q$1(O$1.$), o = Tt.le();
        x$1(e, (function(e, s) {
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.ra = function(t, e, n, r) {
        var i = new xn(1 /* Update */ , t, O$1.H), o = [ Yn(t, e) ], s = [ n ];
        if (r.length % 2 != 0) throw new b(A$1.INVALID_ARGUMENT, "Function " + t + "() needs to be called with an even number of arguments that alternate between field names and values.");
        for (var u = 0; u < r.length; u += 2) o.push(Yn(t, r[u])), s.push(r[u + 1]);
        for (var a = new q$1(O$1.$), h = Tt.le(), c = 0; c < o.length; ++c) {
    ...
    t.prototype.ha = function(t, e, n) {
        void 0 === n && (n = !1);
        var r = new xn(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t, O$1.H);
        return this.na(e, r);
    }, 
    ...
    t.prototype.na = function(t, e) {
        ...
        e.path && e.path.length > 0 && e.se.push(e.path) : x$1(t, (function(t, i) {
            var o = n.na(i, e.Ko(t));
            null != o && (r[t] = o);
        })), {
            mapValue: {
    ...
    t.prototype.ua = function(t, e) {
        ...
        return e.map((function(e, r) {
            ...
            var i = new xn(3 /* Argument */ , t, O$1.H);
 ...
 */
function zn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof S$1 || t instanceof Cn || t instanceof Tn || t instanceof Bn || t instanceof Dn);
}
 ...
 */ function Yn(t, e) {
    ...
    throw new b(A$1.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. Field path arguments must be of type string or FieldPath.");
}
 ...
 */ function Hn(t, e) {
    try {
        return function(t) {
            if (t.search(Sn) >= 0) throw new b(A$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (kn.bind.apply(kn, __spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
                throw new b(A$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).Lo;
    } catch (e) {
        var n = Wn(e);
        throw new b(A$1.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. " + n);
    }
}
 ...
 */ var Xn = /** @class */ function() {
    ...
    t.prototype.pa = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new b(A$1.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.va(e);
            }));
        }));
    ...
    return __extends(n, e), n.prototype.Sa = function(t) {
    ...
    return __extends(n, e), Object.defineProperty(n.prototype, "La", {
        /**
    ...
    /** Gets an auth token and invokes the provided RPC. */ t.prototype.Qa = function(t, e) {
        ...
        return this.credentials.getToken().then((function(r) {
            ...
            throw t.code === A$1.UNAUTHENTICATED && n.credentials.l(), t;
        }));
    }, 
    ...
    return t.prototype.Wa = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.Xa(), this.mutations.length > 0) throw new b(A$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        ...
        if (null !== n) {
            ...
            throw new b(A$1.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.Za = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new b(A$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    r.isEqual(D$1.MIN) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this.uu.ho() ]);
    ...
    t.prototype.Bu = function(t) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                ...
                // logic kick in.
                return Xt(r = t.code) && r !== A$1.ABORTED ? (e = this.cu.shift(), [ 2 /*return*/ , (this.Pu.ma(), 
    ...
    return t.prototype.Cc = function() {
        ...
        try {
            ...
            return !z$1(e) && e.catch && e.then ? e : (this.Lr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    ...
                    void r.reject(new b(A$1.UNAVAILABLE, "Failed to persist write: " + i))) ];
                    throw i;
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.Qc = this.Qc.remove(i), this.Wc.delete(t), this.il(), o = (o = new P$1(U$1.$)).nt(i, new Dt(i, D$1.S())), 
                    s = oe().add(i), u = new fe(D$1.MIN, 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new q$1(Ue), o, s), [ 2 /*return*/ , this.oo(u) ]) : [ 4 /*yield*/ , this.uu.bo(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.Zc(t, r);
                    })).catch(nn) ];
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.ol = function(t) {
        this.Kc.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new b(A$1.CANCELLED, t));
            }));
        })), this.Kc.clear();
    }, t.prototype.tl = function(t, e) {
        var n = this.Gc[this.currentUser.s()];
        n || (n = new P$1(Ue)), n = n.nt(t, e), this.Gc[this.currentUser.s()] = n;
    }, 
    /**
    ...
    return t.prototype.Bh = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.Me() || n.isEqual(D$1.MIN) ? this.Sl(t, e) : this.vl.sr(t, r).next((function(o) {
            var u = i.Dl(e, o);
            return (e.je() || e.Ge()) && i.Rc(e.pe, u, r, n) ? i.Sl(t, e) : (_e() <= LogLevel.DEBUG && Se("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
    ...
    return t.prototype.Nl = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                U$1.st(i) || (i = i.child(""));
        var o = new Be(new U$1(i), 0), s = new q$1(Ue);
...
vr.Ql = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype.Ac = function(t) {
        var e = this, n = [];
...
var mr = /** @class */ function() {
    function t(t) {
        ...
        this.lastRemoteSnapshotVersion = D$1.MIN, 
    ...
    return t.prototype.initialize = function(t) {
        ...
        throw new b(A$1.FAILED_PRECONDITION, "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.");
    }, t;
}(), br = /** @class */ function() {
    function t(t, e, n, 
    /**
    ...
    t.prototype.Q_ = function(t) {
        return "FirebaseError" === t.name ? t.code === A$1.FAILED_PRECONDITION || t.code === A$1.UNIMPLEMENTED : !("undefined" != typeof DOMException && t instanceof DOMException) || 
    ...
    t.prototype.O_ = function() {
        if (this.Nr.Jr) throw new b(A$1.FAILED_PRECONDITION, "The client has already been terminated.");
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return this.O_(), this.Nr.enqueue((function() {
            ...
            throw new b(A$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)");
        }));
...
var Tr = /** @class */ function() {
    ...
    return t.prototype.X_ = function(t) {
        ...
        var e = V$1.K(t);
        Le(Ne(e));
        var n = new Me(e.get(1), e.get(3)), r = new U$1(e.L(5));
    ...
    function t(t) {
        var e, n;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new b(A$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
        ...
        fn("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Ke.mh; else {
            if (t.cacheSizeBytes !== _r && t.cacheSizeBytes < Ke.Ih) throw new b(A$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Ke.Ih);
    ...
    function t(r, i, o) {
        ...
        this.rf = new $e, this.INTERNAL = {
            ...
            var u = r;
            this.nf = u, this.if = t.uf(u), this.cf = u.name, this.lf = new T$1(i);
        } else {
            var a = r;
            if (!a.projectId) throw new b(A$1.INVALID_ARGUMENT, "Must provide projectId");
            this.if = new Me(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.cf = "[DEFAULT]", this.lf = new I$1;
        }
    ...
    return t.prototype.settings = function(t) {
        ...
        var e = new kr(t);
        if (this.af && !this.ff.isEqual(e)) throw new b(A$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        this.ff = e, void 0 !== e.credentials && (this.lf = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new b(A$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
    }, t.prototype.enableNetwork = function() {
        ...
        var e, n;
        if (this.af) throw new b(A$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1;
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(i) {
                if (void 0 !== this.af && !this.af.j_) throw new b(A$1.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
        ...
        return new jn(e, (function(e) {
            if (e instanceof Vr) {
                ...
                if (!r.isEqual(n)) throw new b(A$1.INVALID_ARGUMENT, "Document reference is for database " + r.projectId + "/" + r.database + " but should be for database " + n.projectId + "/" + n.database);
                return new Bn(t, e.Af);
            }
            return e;
        }));
    }, t.uf = function(t) {
        if (e = t.options, !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new b(A$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
        var e, n = t.options.projectId;
        // Export the classes with a private constructor (it will fail if invoked
        // at runtime). Note that this still allows instanceof checks.
        // We're treating the variables as class names, so disable checking for lower
        // case variable names.
                if (!n || "string" != typeof n) throw new b(A$1.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new Me(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.nf) throw new b(A$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.nf;
        },
        enumerable: !0,
        configurable: !0
        ...
        this.hf(), new Mr(V$1.K(t), this);
    }, t.prototype.doc = function(t) {
        return on("Firestore.doc", arguments, 1), an("Firestore.doc", "non-empty string", 1, t), 
        this.hf(), Vr.Pf(V$1.K(t), this);
    }, t.prototype.collectionGroup = function(t) {
        if (on("Firestore.collectionGroup", arguments, 1), an("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new b(A$1.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        return this.hf(), new Pr(new Lt(V$1.H, t), this);
        ...
        t) {
          ...
          default:
            throw new b(A$1.INVALID_ARGUMENT, "Invalid log level: " + t);
        }
    }, 
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        if (this.vf) throw new b(A$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Vr = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.Pf = function(e, n, r) {
        if (e.length % 2 != 0) throw new b(A$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + e.G() + " has " + e.length);
        ...
        !t) throw new b(A$1.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = V$1.K(t);
        ...
        var r = this.Df({
            ...
            next: function(i) {
                ...
                e(new b(A$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : i.exists && i.metadata.fromCache && n && "server" === n.source ? e(new b(A$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : t(i);
            },
            error: e
        });
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        on("Query.where", arguments, 3), vn("Query.where", 3, r), function(t, e, n, r) {
            if (!e.some((function(t) {
                return t === r;
            }))) throw new b(A$1.INVALID_ARGUMENT, "Invalid value " + yn(r) + " provided to function Query.where() for its " + En(2) + " argument. Acceptable values: " + e.join(", "));
        }(0, [ "<", "<=", "==", ">=", ">", "array-contains", "in", "array-contains-any" ], 0, n);
        var o = Yn("Query.where", e), s = Ot.K(n);
        if (o.X()) {
            if (s === Ot.ARRAY_CONTAINS || s === Ot.ARRAY_CONTAINS_ANY) throw new b(A$1.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + s.toString() + "' queries on FieldPath.documentId().");
            if (s === Ot.IN) {
                this.Lf(r, s);
        ...
        void 0 === n || "asc" === n) r = Ft.ASCENDING; else {
            if ("desc" !== n) throw new b(A$1.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = Ft.DESCENDING;
        }
        if (null !== this.kf.startAt) throw new b(A$1.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.kf.endAt) throw new b(A$1.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.Bf = function(t, e, n, r) {
        if (vn(t, 1, e), e instanceof Or) {
            if (n.length > 0) throw new b(A$1.INVALID_ARGUMENT, "Too many arguments provided to " + t + "().");
            var i = e;
            if (!i.exists) throw new b(A$1.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + t + "().");
    ...
    t.prototype.xf = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.kf.orderBy; r < i.length; r++) {
            ...
            if (o.field.X()) n.push(it(this.firestore.if, t.key)); else {
                ...
                if (Y$1(s)) throw new b(A$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + o.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === s) {
                    var u = o.field.G();
                    throw new b(A$1.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + u + "' (used as the orderBy) does not exist.");
                }
                n.push(s);
            }
        }
    ...
    t.prototype.Uf = function(t, e, n) {
        ...
        var r = this.kf.Ve;
        if (e.length > r.length) throw new b(A$1.INVALID_ARGUMENT, "Too many arguments provided to " + t + "(). The number of arguments must be less than or equal to the number of Query.orderBy() clauses");
        for (var i = [], o = 0; o < e.length; o++) {
            var s = e[o];
            if (r[o].field.X()) {
                if ("string" != typeof s) throw new b(A$1.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + t + "(), but got a " + typeof s);
                if (!this.kf.ze() && -1 !== s.indexOf("/")) throw new b(A$1.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.kf.path.child(V$1.K(s));
                if (!U$1.st(u)) throw new b(A$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new U$1(u);
        ...
        if (t.Ge() && 0 === t.Ve.length) throw new b(A$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }, t.prototype.get = function(t) {
        var e = this;
        ...
        var r = this.Df({
            ...
            next: function(i) {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                r(), i.metadata.fromCache && n && "server" === n.source ? e(new b(A$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : t(i);
            },
            error: e
        });
    }, 
    ...
    t.prototype.Of = function(t) {
        if ("string" == typeof t) {
            if ("" === t) throw new b(A$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!this.kf.ze() && -1 !== t.indexOf("/")) throw new b(A$1.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.kf.path.child(V$1.K(t));
            if (!U$1.st(e)) throw new b(A$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return it(this.firestore.if, new U$1(e));
        }
        if (t instanceof Vr) {
            var n = t;
            return it(this.firestore.if, n.Af);
        }
        throw new b(A$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + yn(t) + ".");
    }, 
    /**
    ...
    t.prototype.Lf = function(t, e) {
        if (!Array.isArray(t) || 0 === t.length) throw new b(A$1.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
        if (t.length > 10) throw new b(A$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
        if (t.indexOf(null) >= 0) throw new b(A$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
        if (t.filter((function(t) {
            return Number.isNaN(t);
        })).length > 0) throw new b(A$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
        ...
        if (t instanceof Ut) {
            ...
            if (t.Ke()) {
                var o = this.kf.Se();
                if (null !== o && !o.isEqual(t.field)) throw new b(A$1.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + o.toString() + "' and '" + t.field.toString() + "'");
                var s = this.kf.De();
                ...
                throw u === t.op ? new b(A$1.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + t.op.toString() + "' filter.") : new b(A$1.INVALID_ARGUMENT, "Invalid query. You cannot use '" + t.op.toString() + "' filters with '" + u.toString() + "' filters.");
            }
        }
    }, t.prototype.qf = function(t) {
        if (null === this.kf.De()) {
        ...
        if (!e.isEqual(t)) throw new b(A$1.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + t.toString() + "' and so you must also use '" + t.toString() + "' as your first Query.orderBy(), but your first Query.orderBy() is on field '" + e.toString() + "' instead.");
    }, t;
}(), Cr = /** @class */ function() {
    function t(t, e, n, r) {
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        if (e && this.Gf.fs) throw new b(A$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, Lt.ve(t), n, r) || this).Yf = t, t.length % 2 != 1) throw new b(A$1.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.G() + " has " + t.length);
        return i;
    }
    return __extends(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.B() ? null : new Vr(new U$1(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
        ...
        "" === t) throw new b(A$1.INVALID_ARGUMENT, "Document path must be a non-empty string");
        var e = V$1.K(t);
...
function qr(t, e) {
    ...
    if (mn(t, e, [ "merge", "mergeFields" ]), fn(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new b(A$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + yn(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new b(A$1.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + yn(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof kn;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new b(A$1.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
...
function xr(t, e, n) {
    if (e instanceof Vr) {
        if (e.firestore !== n) throw new b(A$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
...
var zr = bn(Sr, "Use firebase.firestore() instead."), Qr = bn(Dr, "Use firebase.firestore().runTransaction() instead."), Yr = bn(Rr, "Use firebase.firestore().batch() instead."), Hr = bn(Vr, "Use firebase.firestore().doc() instead."), Wr = bn(Or), Xr = bn(Ur), $r = bn(Pr), Kr = bn(Cr), Zr = bn(Mr, "Use firebase.firestore().collection() instead."), Jr = {
     ...
     */    return t.prototype.wd = function(t, e) {
            ...
            u.listenOnce(tmp_3.COMPLETE, (function() {
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case tmp_2.TIMEOUT:
                        Se("Connection", 'RPC "' + t + '" timed out'), s(new b(A$1.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                var i = function(t) {
                                    ...
                                    return Object.values(A$1).indexOf(e) >= 0 ? e : A$1.UNKNOWN;
                                }(r.status);
                                s(new b(i, r.message));
                            } else s(new b(A$1.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        Se("Connection", 'RPC "' + t + '" failed'), s(new b(A$1.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.dd, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = tmp_1(), i = {
        ...
        return v(tmp_4.EventType.OPEN, (function() {
            ...
            d || (d = !0, Se("Connection", "WebChannel transport errored:", t), y._d(new b(A$1.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    ...
                    void 0 === u && (u = A$1.INTERNAL, a = "Unknown error status: " + o + " with message " + i.message), 
