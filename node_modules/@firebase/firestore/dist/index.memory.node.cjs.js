...
var ObjectValue = /** @class */ (function () {
    ...
    ObjectValue.newBuilder = function () {
    ...
    ObjectValue.prototype.extractFieldMask = function (value) {
        var _this = this;
        var fields = new SortedSet(FieldPath.comparator);
        forEach(value.fields || {}, function (key, value) {
            var currentPath = new FieldPath([key]);
            if (typeOrder(value) === 10 /* ObjectValue */) {
                var nestedMask = _this.extractFieldMask(value.mapValue);
    ...
    ObjectValue.prototype.toBuilder = function () {
        return new ObjectValueBuilder(this);
    };
    return ObjectValue;
}());
ObjectValue.EMPTY = new ObjectValue({ mapValue: {} });
/**
    ...
    TransformMutation.prototype.extractBaseValue = function (maybeDoc) {
        ...
        for (var _i = 0, _c = this.fieldTransforms; _i < _c.length; _i++) {
            ...
            if (coercedValue != null) {
                if (baseObject == null) {
                    baseObject = ObjectValue.newBuilder().set(fieldTransform.field, coercedValue);
                }
                else {
...
var LocalStore = /** @class */ (function () {
    ...
    LocalStore.prototype.notifyLocalViewChanges = function (viewChanges) {
        ...
        return this.persistence.runTransaction('notifyLocalViewChanges', 'readwrite', function (txn) {
            return PersistencePromise.forEach(viewChanges, function (viewChange) {
                return PersistencePromise.forEach(viewChange.removedKeys, function (key) { return _this.persistence.referenceDelegate.removeReference(txn, key); });
            });
        });
    };
    /**
    ...
    LocalStore.prototype.releaseTarget = function (targetId, keepPersistedTargetData) {
        ...
        return this.persistence
            ...
            if (!keepPersistedTargetData) {
                return PersistencePromise.forEach(removed, function (key) { return _this.persistence.referenceDelegate.removeReference(txn, key); }).next(function () {
                    _this.persistence.referenceDelegate.removeTarget(txn, targetData);
                });
            }
            else {
    ...
    LocalStore.prototype.remoteDocumentKeys = function (targetId) {
        ...
        return this.persistence.runTransaction('Remote document keys', 'readonly', function (txn) {
            return _this.targetCache.getMatchingKeysForTargetId(txn, targetId);
        });
    };
    ...
    Query.prototype.toTarget = function () {
        if (!this.memoizedTarget) {
            if (this.limitType === "F" /* First */) {
                ...
                for (var _i = 0, _c = this.orderBy; _i < _c.length; _i++) {
                    var orderBy = _c[_i];
                    var dir = orderBy.dir === Direction.DESCENDING
                        ? Direction.ASCENDING
    ...
    FieldFilter.create = function (field, op, value) {
        if (field.isKeyField()) {
            if (op === Operator.IN) {
                ...
                debugAssert(op !== Operator.ARRAY_CONTAINS && op !== Operator.ARRAY_CONTAINS_ANY, "'" + op.toString() + "' queries don't make sense on document keys.");
...
var SyncEngine = /** @class */ (function () {
    ...
    SyncEngine.prototype.removeAndCleanupTarget = function (targetId, error) {
        ...
        if (this.isPrimaryClient) {
            var limboKeys = this.limboDocumentRefs.referencesForId(targetId);
 ...
 * limitations under the License.
 */
var LOG_TAG$3 = 'OnlineStateTracker';
...
var LOG_TAG$4 = 'WatchChangeAggregator';
/**
...
var WatchChangeAggregator = /** @class */ (function () {
    ...
    WatchChangeAggregator.prototype.isActiveTarget = function (targetId) {
        ...
        if (!targetActive) {
            logDebug(LOG_TAG$4, 'Detected inactive target', targetId);
        }
        return targetActive;
    };
    /**
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (this.writePipeline.length > 0) {
                            logDebug(LOG_TAG$5, "Stopping write stream with " + this.writePipeline.length + " pending writes");
                            this.writePipeline = [];
                        }
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_c) {
                ...
                if (isPermanentError(error.code)) {
                    logDebug(LOG_TAG$5, 'RemoteStore error before completed handshake; resetting stream token: ', this.writeStream.lastStreamToken);
            ...
            return tslib.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        logDebug(LOG_TAG$5, 'RemoteStore restarting streams for new credential');
                        return [4 /*yield*/, this.restartNetwork()];
                    case 1:
                        _c.sent();
                        _c.label = 2;
...
var FirestoreClient = /** @class */ (function () {
    ...
    FirestoreClient.prototype.start = function (componentProvider, persistenceSettings) {
        ...
        this.credentials.setChangeListener(function (user) {
            if (!initialized) {
                initialized = true;
                logDebug(LOG_TAG$8, 'Initializing. user=', user.uid);
    ...
    FirestoreClient.prototype.handleCredentialChange = function (user) {
        ...
        logDebug(LOG_TAG$8, 'Credential Changed. Current user: ' + user.uid);
            ...
            var retryingOp = function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                ...
                return tslib.__generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 2:
                            e_2 = _c.sent();
                            if (e_2.name === 'IndexedDbTransactionError') {
                                logDebug(LOG_TAG$9, 'Operation failed with retryable error: ' + e_2);
...
var UserDataReader = /** @class */ (function () {
    function UserDataReader(serializer, preConverter) {
        this.serializer = serializer;
        this.preConverter = preConverter;
    }
    /** Parse document data from a non-merge set() call. */
    UserDataReader.prototype.parseSetData = function (methodName, input) {
        var context = new ParseContext(0 /* Set */, methodName, FieldPath.EMPTY_PATH);
        validatePlainObject('Data must be an object, but it was:', context, input);
        var updateData = this.parseObject(input, context);
    ...
    UserDataReader.prototype.parseMergeData = function (methodName, input, fieldPaths) {
        var context = new ParseContext(2 /* MergeSet */, methodName, FieldPath.EMPTY_PATH);
        validatePlainObject('Data must be an object, but it was:', context, input);
        var updateData = this.parseObject(input, context);
        var fieldMask;
        var fieldTransforms;
    ...
    UserDataReader.prototype.parseUpdateData = function (methodName, input) {
        var _this = this;
        var context = new ParseContext(1 /* Update */, methodName, FieldPath.EMPTY_PATH);
        validatePlainObject('Data must be an object, but it was:', context, input);
        var fieldMaskPaths = new SortedSet(FieldPath.comparator);
        var updateData = ObjectValue.newBuilder();
    ...
    UserDataReader.prototype.parseQueryValue = function (methodName, input, allowArrays) {
        ...
        var context = new ParseContext(allowArrays ? 4 /* ArrayArgument */ : 3 /* Argument */, methodName, FieldPath.EMPTY_PATH);
    ...
    UserDataReader.prototype.runPreConverter = function (input, context) {
        try {
     ...
     */
    UserDataReader.prototype.parseData = function (input, context) {
    ...
    UserDataReader.prototype.parseObject = function (obj, context) {
        var _this = this;
        var fields = {};
        if (isEmpty(obj)) {
    ...
    UserDataReader.prototype.parseArray = function (array, context) {
        var values = [];
        var entryIndex = 0;
     ...
     */
    UserDataReader.prototype.parseSentinelFieldValue = function (value, context) {
        ...
        if (value instanceof DeleteFieldValueImpl) {
            ...
            var numericIncrement = new NumericIncrementTransformOperation(this.serializer, operand);
     ...
     */
    UserDataReader.prototype.parseScalarValue = function (value, context) {
        if (value === null) {
            ...
            return {
                referenceValue: this.serializer.toResourceName(value.key.path, value.databaseId)
            };
        }
        else {
    ...
    UserDataReader.prototype.parseArrayTransformElements = function (methodName, elements) {
        var _this = this;
        return elements.map(function (element, i) {
            // Although array transforms are used with writes, the actual elements
            // being unioned or removed are not considered writes since they cannot
            // contain any FieldValue sentinels, etc.
            var context = new ParseContext(3 /* Argument */, methodName, FieldPath.EMPTY_PATH);
...
var Firestore = /** @class */ (function () {
    ...
    Firestore.prototype.createDataReader = function (databaseId) {
        ...
        var serializer = PlatformSupport.getPlatform().newSerializer(databaseId);
