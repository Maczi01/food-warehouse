    ...
    async write(batch, userCallback) {
        ...
        try {
            ...
            if (e.name === 'IndexedDbTransactionError') {
                ...
                logError(LOG_TAG$2, 'Dropping write that cannot be persisted: ' + e);
 ...
 * limitations under the License.
 */
const LOG_TAG$3 = 'OnlineStateTracker';
...
const LOG_TAG$4 = 'WatchChangeAggregator';
/**
 ...
 * limitations under the License.
 */
const LOG_TAG$8 = 'FirestoreClient';
